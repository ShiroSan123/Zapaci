...
<body class="relative h-full">
	...
	<section class="h-full">
		...
		<section class="text-center">
			<h1
				class="w-[calc(100vw*0.32239583)] text-left text-[#2563EB] text-[80px] font-bold leading-[107px] bg-[url('/src/assets/vector2.png')] bg-no-repeat bg-contain bg-bottom ml-[calc(100vw*0.086458)]">
				Прогноз.</h1>
			<div class="w-[calc(100vw*0.83125)] grid gap-x-[20px] mx-auto mt-5">
				<p class="text-[30px] font-normal text-left w-[calc(100vw*0.3645833)]">Алгоритм считает методом
					скользящей средней, на основе
					предыдущих месяцев.
				</p>
				<div class="mt-5 w-[calc(100vw*0.0,83125)] relative gap-y-5 grid grid-cols-2">
					<div
						class="relative w-[calc(100vw*0.4104166)] h-[calc(100vh*0.1509259259)] border border-dashed border-black rounded-[10px] pl-[22px]">
						<div
						...
						<div class="grid grid-cols-2">
							<div class="w-[385px] text-left">
								<h1 class="text-[40px] font-semibold">Огурцы “Саюри”</h1>
								<button
							...
							<div class="w-[338px] text-left pt-[calc(100vh*0.030555)] grid gap-y-[9px]">
								<p class="text-[20px] font-normal">прогноз на следующий месяц</p>
								<section class="flex justify-between">
									<p class="text-[20px] font-normal" name="ost">нужно</p>
									<p class="text-[15px] text-[#808080] font-normal">38 шт.</p>
								</section>
								<section class="flex justify-between">
