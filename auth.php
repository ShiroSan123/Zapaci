...
<body class="relative h-full">
	...
	<section class="h-full">
		...
		<section class="text-center mx-auto w-[653px] h-[800px] border border-black rounded-[10px]">
			...
			<p class="text-[40px]">Регистрация</p>
			<p class="text-[40px]">Есть аккаунт? <a href="auth.php?log=2" class="text-[#121BFF]">Войдите</a>
			</p>
			<form action="" class="">
				...
				<button
					class="mt-8 px-[75px] py-[5px] rounded-[50px] text-white text-[32px] font-bold bg-[#2563EB]">далее</button>
			</form>
		</section>
		<?php } elseif($log == 2) { ?>
		<section class="text-center mx-auto w-[653px] h-[800px] border border-black rounded-[10px]">
			...
			<h1 class="leading-[54px] text-[70px] font-extrabold"><span class="text-[#121BFF]">запас</span>ись<span
					class="text-[#121BFF]">.</span></h1>
			<p class="text-[40px]">Авторизация</p>
			<p class="text-[40px]">Нет аккаунта? <a href="auth.php?log=1" class="text-[#121BFF]">Зарегистрируйтесь</a>
			</p>
			<form action="" class="mt-[117px]">
				<input type="text" class="mt-[11px] w-[535px] h-[49px] rounded-[10px] border border-[#BCBCBC] pl-[18px]"
					placeholder="Номер телефона" required name="Phone">
				<input type="password"
					class="mt-[11px] w-[535px] h-[49px] rounded-[10px] border border-[#BCBCBC] pl-[18px]"
